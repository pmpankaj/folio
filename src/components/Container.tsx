...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Pankaj Tiwari | Portfolio",
    description: `Agile product leader with 13+ years of experience.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://pankajt.vercel.app${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://pankajt.vercel.app${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Pankaj Tiwari" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Pankaj Tiwari</span>
        </Link>
          ...
          {isOpen && (
            ...
            >
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                {/* Footer */}
                <div className="flex min-h-fit w-full flex-col items-center space-y-8 px-[22px] py-10">
