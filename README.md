...
[Website Preview](pankajt.vercel.app)

[🔗 Link to portfolio](pankajt.vercel.app)

Personalize the portfolio by modifying `src/pages/index.tsx` and `src/styles/globals.css` to emulate your own portfolio. Made some improvements and want to share? Open a pull request.
...
$ git clone https://github.com/contacttiwari/folio.git
